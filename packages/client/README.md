...
The client sdk to be used to empower develoeprs to leverage the Haste Arcade. The client SDK is intended to be used in browser alongside the developers game code.
